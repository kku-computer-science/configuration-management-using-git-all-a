...
1. **Initial Setup:** Member 1 (Worachat) สร้าง brach ของตัวเอง สร้างโฟลเดอร์ และ ไฟล์ที่จำเป็นเช่น AboutMyTeam, Project และ TeamWorkflow.md พร้อมส่งโค้ด algorithm Quick Sort ขึ้น Main Branch เรียบร้อยแล้ว
